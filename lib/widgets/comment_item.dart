                    ...
                    child: Container(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          ...
                          GestureDetector(
                              onTap: () => _updateLikeCount(_currentMyData.myLikeCommentList != null && _currentMyData.myLikeCommentList.contains(widget.data['commentID']) ? true : false),
                              child: Text('Like',
                                  style:TextStyle(fontWeight: FontWeight.bold,color:_currentMyData.myLikeCommentList != null && _currentMyData.myLikeCommentList.contains(widget.data['commentID']) ? Colors.blue[900] : Colors.grey[700]))
                          ),
                          GestureDetector(
                              onTap: (){
